                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img style="width: 150px; height: 100px; object-fit: contain;" src="{{ URL::to($record->image_url) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="cms_role_id" class="form-control">
                                            <option required value="">-- Select Privilege --</option>
                                            @if( count($getCmsRole) )
                                                @foreach($getCmsRole as $cmsRole)
                                                    <option {{ $record->cms_role_id == $cmsRole->id ? 'selected' : '' }} value="{{ $cmsRole->id }}">{{ $cmsRole->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
